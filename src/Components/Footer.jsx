    ...
    <div className="container border-top pt-5 footer">
        <div className="row d-flex">
            ...
            <div className="col col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4">
                ...
                <Link to={'/sellonline'}><p>Sell online</p></Link>
                <Link to={'/howitworks'}><p>Price & Commission</p></Link>
                <Link to={'/pricingandcommission'}><p>How it Works</p></Link>
                <Link to={'/shippingandreturns'}><p>Shipping & Returns</p></Link>
                <Link to={'/growbusiness'}><p>Grow Your Business</p></Link>
                <a href=''><p>Shop online on Seedho</p></a>
            </div>
            <div className="col col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4">
                <h4 className='h4 text-dark'>Contact Us</h4>
                <a ><p>Sell@Seesho.comDemo</p></a >
                <a ><p>+91 XXXXX XXXXX</p></a >
            </div>
        </div>
    </div>
    </>

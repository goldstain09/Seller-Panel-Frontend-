      ...
      <div className="container WhySuppliersLoveSeesho">
        <div className="row d-flex">
          <div className="col col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
            ...
            <p>
              All the benefits that come with selling on Seesho are designed to
          ...
          <div className="col col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
            ...
            <div className="row d-flex h-25">
              ...
              <div className="col-10">
                ...
                <p>
                  <i class="bi bi-check2-circle"></i> Easy Product Listing &emsp; &emsp;
                  <i class="bi bi-check2-circle"></i> Lowest Cost Shipping<br />

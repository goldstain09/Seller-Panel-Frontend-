  ...
  return (
    <>
      ...
      <h1 className="text-center mt-5 pt-5 h1">
        Why Sell Your Products On Seesho?
      </h1>
          ...
          <div className="col col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
            <div>
              ...
              <p>
                ...
                hassle-free selling experience on Seesho.
              </p>
            </div>
          </div>
          <div className="col col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
            <div>
              ...
              <h5>Customers</h5>
              <p>
                Seesho is one of the largest and fastest growing online selling
                platforms in India with over 14 Crore+ customers.
              </p>
            </div>
          </div>
          <div className="col col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
